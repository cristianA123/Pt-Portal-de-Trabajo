<?php
namespace App\Modules\Shared\sign;
...
class Signature {
    public function signature_xml($flg_firma, $ruta, $ruta_firma, $pass_firma) {        
        ...
        $pfx = file_get_contents('D:\dev\Emprendimiento\API-Sunat-Laravel\storage\app\public\certificado\certificado_prueba.pfx');
        $key = array();
